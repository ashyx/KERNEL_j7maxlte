...
void (*mtk_set_gpu_lowbound_freq_fp)(unsigned long ulFreq) = NULL;
EXPORT_SYMBOL(mtk_set_gpu_lowbound_freq_fp);

bool mtk_set_gpu_lowbound_freq(unsigned long ulFreq)
{

	if (mtk_set_gpu_lowbound_freq_fp != NULL) {
		mtk_set_gpu_lowbound_freq_fp(ulFreq);
		return true;
	}
	return false;
}
EXPORT_SYMBOL(mtk_set_gpu_lowbound_freq);

/*-----------------------------------------------------------------------------*/

void (*mtk_set_gpu_upbound_freq_fp)(unsigned long ulFreq) = NULL;
EXPORT_SYMBOL(mtk_set_gpu_upbound_freq_fp);

bool mtk_set_gpu_upbound_freq(unsigned long ulFreq)
{

	if (mtk_set_gpu_upbound_freq_fp != NULL) {
		mtk_set_gpu_upbound_freq_fp(ulFreq);
		return true;
	}
	return false;
}
EXPORT_SYMBOL(mtk_set_gpu_upbound_freq);
