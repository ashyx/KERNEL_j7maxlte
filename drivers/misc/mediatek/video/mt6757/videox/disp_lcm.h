...
int disp_lcm_cmd_q(struct disp_lcm_handle *plcm, int enable);
int disp_dsi_set_withcmdq(struct disp_lcm_handle *plcm, void *cmdq, unsigned cmd, unsigned char count,
		unsigned char *para_list, unsigned char force_update);
int disp_dsi_set_withrawcmdq(struct disp_lcm_handle *plcm, void *cmdq, unsigned int *pdata,
		unsigned int queue_size, unsigned char force_update);
int disp_lcm_util_set_read_cmdq_cmd_v2(struct disp_lcm_handle *plcm, void *handle, unsigned data_id,
					unsigned offset, unsigned cmd, unsigned char *buffer, unsigned char size);
