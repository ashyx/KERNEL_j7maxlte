...
/* DTS state */
enum DTS_GPIO_STATE {
	DTS_GPIO_STATE_LCD_VDD_1P8_OUT0 = 0,	/* lcd_vpp_1p8_out0 */
	DTS_GPIO_STATE_LCD_VDD_1P8_OUT1,	/* lcd_vpp_1p8_out1*/
	DTS_GPIO_STATE_LCM_RST_OUT0,
	DTS_GPIO_STATE_LCM_RST_OUT1,
	DTS_GPIO_STATE_LCD_VSP_5P5_EN0,
	DTS_GPIO_STATE_LCD_VSP_5P5_EN1,
	DTS_GPIO_STATE_LCD_VSN_5P5_EN0,
	DTS_GPIO_STATE_LCD_VSN_5P5_EN1,
	DTS_GPIO_STATE_LCD_BL_EN0,
	DTS_GPIO_STATE_LCD_BL_EN1,
	DTS_GPIO_STATE_TSP_RST_EN0,
	DTS_GPIO_STATE_TSP_RST_EN1,
	DTS_GPIO_STATE_DISP_DSI_TE,
