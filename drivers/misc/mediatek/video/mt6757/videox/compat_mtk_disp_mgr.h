...
#define COMPAT_DISP_IOCTL_INSERT_SESSION_BUFFERS	DISP_IOW(219, struct compat_disp_session_buf_info)
#define	COMPAT_DISP_IOCTL_FRAME_CONFIG			DISP_IOW(220, struct compat_disp_session_output_config)
#define COMPAT_DISP_IOCTL_QUERY_VALID_LAYER		DISP_IOW(221, struct _compat_disp_layer_info)
