...
EXPORT_SYMBOL(read_offset);
UINT32 DSI_dcs_read_lcm_reg_v2_1(enum DISP_MODULE_ENUM module, struct cmdqRecStruct *cmdq,
				UINT8 data_id, UINT8 offset, UINT8 cmd, UINT8 *buffer, UINT8 buffer_size)
{
	int dsi_i = 0;
	struct DSI_T0_INS t0;
	struct DSI_T0_INS t1;
	...
	*/
	...
	cmdqRecSetEventToken(cmdq, CMDQ_SYNC_TOKEN_CONFIG_DIRTY);
	cmdqRecSetEventToken(cmdq, CMDQ_SYNC_TOKEN_CABC_EOF);
	cmdqRecFlush(cmdq);
...
unsigned int DSI_dcs_read_cmdq_lcm_reg_v2_1_wrapper_DSI0(void *cmdq, UINT8 data_id, UINT8 offset, UINT8 cmd,
		UINT8 *buffer, UINT8 buffer_size)
{
	return DSI_dcs_read_lcm_reg_v2_1(DISP_MODULE_DSI0, cmdq, data_id, offset, cmd, buffer, buffer_size);
}

unsigned int DSI_dcs_read_cmdq_lcm_reg_v2_1_wrapper_DSI1(void *cmdq, UINT8 data_id, UINT8 offset, UINT8 cmd,
		UINT8 *buffer, UINT8 buffer_size)
{
	return DSI_dcs_read_lcm_reg_v2_1(DISP_MODULE_DSI1, cmdq, data_id, offset, cmd, buffer, buffer_size);
}

unsigned int DSI_dcs_read_cmdq_lcm_reg_v2_1_wrapper_DSIDUAL(void *cmdq, UINT8 data_id, UINT8 offset, UINT8 cmd,
		UINT8 *buffer, UINT8 buffer_size)
{
	return DSI_dcs_read_lcm_reg_v2_1(DISP_MODULE_DSIDUAL, cmdq, data_id, offset, cmd, buffer, buffer_size);
}


long lcd_vpp_1p8_out(unsigned int value)
{
	long ret = 0;
#if !defined(CONFIG_MTK_LEGACY)
	if (value)
		ret = disp_dts_gpio_select_state(DTS_GPIO_STATE_LCD_VDD_1P8_OUT1);
	else
		ret = disp_dts_gpio_select_state(DTS_GPIO_STATE_LCD_VDD_1P8_OUT0);
#endif
	return ret;
}

long lcd_vsp_5p5_out(unsigned int value)
{
	long ret = 0;
#if !defined(CONFIG_MTK_LEGACY)
	if (value)
		ret = disp_dts_gpio_select_state(DTS_GPIO_STATE_LCD_VSP_5P5_EN1);
	else
		ret = disp_dts_gpio_select_state(DTS_GPIO_STATE_LCD_VSP_5P5_EN0);
#endif
	return ret;
}

long lcd_vsn_5p5_out(unsigned int value)
{
	long ret = 0;
#if !defined(CONFIG_MTK_LEGACY)
	if (value)
		ret = disp_dts_gpio_select_state(DTS_GPIO_STATE_LCD_VSN_5P5_EN1);
	else
		ret = disp_dts_gpio_select_state(DTS_GPIO_STATE_LCD_VSN_5P5_EN0);
#endif
	return ret;
}
...
long tsp_rst_out(unsigned int value)
{
	long ret = 0;
#if !defined(CONFIG_MTK_LEGACY)
	if (value)
		ret = disp_dts_gpio_select_state(DTS_GPIO_STATE_TSP_RST_EN1);
	else
		ret = disp_dts_gpio_select_state(DTS_GPIO_STATE_TSP_RST_EN0);
#endif
	return ret;
}
...
int ddp_dsi_set_lcm_utils(enum DISP_MODULE_ENUM module, LCM_DRIVER *lcm_drv)
{
	...
	if (module == DISP_MODULE_DSI0) {
		...
		utils->dsi_dcs_read_cmdq_lcm_reg_v2_1 = DSI_dcs_read_cmdq_lcm_reg_v2_1_wrapper_DSI0;
		...
		utils->dsi_dcs_read_cmdq_lcm_reg_v2_1 = DSI_dcs_read_cmdq_lcm_reg_v2_1_wrapper_DSI1;
		...
		if (lcm_param.lcm_cmd_if == LCM_INTERFACE_DSI0) {
			...
			utils->dsi_dcs_read_cmdq_lcm_reg_v2_1 = DSI_dcs_read_cmdq_lcm_reg_v2_1_wrapper_DSIDUAL;
	...
	utils->set_gpio_lcd_vpp_1p8 = lcd_vpp_1p8_out;
	utils->set_gpio_lcd_vsp_5p5 = lcd_vsp_5p5_out;
	utils->set_gpio_lcd_vsn_5p5 = lcd_vsn_5p5_out;
	utils->set_gpio_lcd_rst_enp = lcd_rst_enp_out;
	utils->set_gpio_blic_en_enp = blic_en_enp_out;
	utils->set_gpio_tsp_rst = tsp_rst_out;
