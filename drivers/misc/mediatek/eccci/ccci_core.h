...
#define CCCI_IOC_DRV_ENTER_UPLOAD	_IO(CCCI_IOC_MAGIC, 64) /* modem log for s */
#define CCCI_IOC_LOG_LVL		_IOW(CCCI_IOC_MAGIC, 65, unsigned int) /* modem log for s */
#define CCCI_IOC_FORCE_MD_OFF		_IO(CCCI_IOC_MAGIC, 66) /* force power off modem for s factory mode */
#define CCCI_IOC_GET_MD_STATE_SYNC	_IOR(CCCI_IOC_MAGIC, 67, unsigned int) /* meta for s */
