#ifndef __S6E3FA3_AMS549KU2X_PARAM_H__
#define __S6E3FA3_AMS549KU2X_PARAM_H__

#include <linux/types.h>
#include <linux/kernel.h>
#include "dynamic_aid_s6e3fa3_ams549ku2x.h"
...
static unsigned char SEQ_AVC_SETTING[] = {
	0xFD,
	0xA1, 0x20, 0x08, 0x04, 0x44, 0x00, 0x0C, 0x07, 0x00, 0x00,
	0xFF, 0x00, 0x0A, 0xAA, 0x0A, 0xAA, 0x0A, 0xAA, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x5A, 0x80, 0x57, 0x65,
	0xB2			/* AVC 6.5V Setting */
};
...
static unsigned char SEQ_OSC_FREQ_ADJ[] = {
	0xCE,
	0x29, 0xD0, 0x58, 0xC3, 0x4B, 0x38, 0x06, 0x03, 0x00, 0xFF,
...
static unsigned char SEQ_SELECT_HLPM_60[] = {
	0xBB,
	0x14, 0x00, 0x07, 0x12	/* 0x14 : HLPM 60nit Mode */
};

static unsigned char SEQ_SELECT_HLPM_02[] = {
	0xBB,
	0x54, 0x00, 0x07, 0x12	/* 0x54 : HLPM 2nit Mode */
};

static unsigned char SEQ_SELECT_ALPM_60[] = {
	0xBB,
	0x84, 0x00, 0x07, 0x12	/* 0x84 : ALPM 60nit Mode */
};

static unsigned char SEQ_SELECT_ALPM_02[] = {
	0xBB,
	0xC4, 0x00, 0x07, 0x12	/* 0xC4 : ALPM 2nit Mode */
};

static unsigned char SEQ_SELECT_60NIT_ON[] = {
	0x53,
	0x02			/* 0x02 : HLPM/ALPM 60nit On */
};

static unsigned char SEQ_SELECT_02NIT_ON[] = {
	0x53,
	0x03			/* 0x03 : HLPM/ALPM 2nit On */
};

static unsigned char SEQ_SRC_LOAD_EN_HLPM[] = {
	0xFD,
	0xA1, 0x20, 0x08, 0x04, 0x44, 0x00, 0x8C,	/* 0x8C : HLPM */
	0x07, 0x00, 0x00,
	0xFF, 0x00, 0x0A, 0xAA, 0x0A, 0xAA, 0x0A, 0xAA, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x5A, 0x80, 0x57, 0x65,
	0xB2, 0x95, 0xA5, 0x04, 0x55, 0x05, 0x01, 0x01, 0x01
};

static unsigned char SEQ_SRC_LOAD_EN_ALPM[] = {
	0xFD,
	0xA1, 0x20, 0x08, 0x04, 0x44, 0x00, 0x0C,	/* 0x0C : ALPM */
	0x07, 0x00, 0x00,
	0xFF, 0x00, 0x0A, 0xAA, 0x0A, 0xAA, 0x0A, 0xAA, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x5A, 0x80, 0x57, 0x65,
	0xB2, 0x95, 0xA5, 0x04, 0x55, 0x05, 0x01, 0x01, 0x01
...
static unsigned char SEQ_ALPM_OFF[] = {
	0x53,
	0x00
};

static unsigned char SEQ_SRC_LOAD_EN_NORMAL[] = {
	0xFD,
...
static unsigned char elvss_mpscon_offset_data[IBRIGHTNESS_HBM_MAX][3] = {
	...
	[IBRIGHTNESS_034NIT ... IBRIGHTNESS_039NIT] = {0xB6, 0xAC, 0x17},
	[IBRIGHTNESS_041NIT ... IBRIGHTNESS_077NIT] = {0xB6, 0xBC, 0x17},
	[IBRIGHTNESS_082NIT ... IBRIGHTNESS_098NIT] = {0xB6, 0xBC, 0x17},
	[IBRIGHTNESS_105NIT ... IBRIGHTNESS_111NIT] = {0xB6, 0xBC, 0x17},
...
#endif /* __S6E3FA3_AMS549KU2X_PARAM_H__ */
