...
/*lcd & blic control*/
#define set_lcd_vpp_1p8(cmd)\
		lcm_util.set_gpio_lcd_vpp_1p8(cmd)
#define set_lcd_vsp_5p5(cmd)\
			lcm_util.set_gpio_lcd_vsp_5p5(cmd)
#define set_lcd_vsn_5p5(cmd)\
			lcm_util.set_gpio_lcd_vsn_5p5(cmd)	
#define set_lcd_rst_en(cmd)\
			lcm_util.set_gpio_lcd_rst_enp(cmd)
#define set_lcd_blic_en(cmd)\
			lcm_util.set_gpio_blic_en_enp(cmd)
#define set_tst_rst_en(cmd)\
			lcm_util.set_gpio_tsp_rst(cmd)
