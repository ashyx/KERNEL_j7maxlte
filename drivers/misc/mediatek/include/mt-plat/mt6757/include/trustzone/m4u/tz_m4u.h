...
typedef struct {
	...
	int l2_en;
	unsigned long long sec_pt_pa;
	unsigned long long sec_pa_start;
	unsigned long long sec_pa_size;
} m4u_init_param_t;
...
typedef struct {
	unsigned long long reserved_mem_start;
	unsigned long long reserved_mem_size;
