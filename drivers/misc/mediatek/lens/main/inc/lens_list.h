...
#define AK7372AF_SetI2Cclient AK7372AF_SetI2Cclient_Main
#define AK7372AF_Ioctl AK7372AF_Ioctl_Main
#define AK7372AF_Release AK7372AF_Release_Main
extern void AK7372AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
...
#define DW9807AF_SetI2Cclient DW9807AF_SetI2Cclient_Main
#define DW9807AF_Ioctl DW9807AF_Ioctl_Main
#define DW9807AF_Release DW9807AF_Release_Main
extern void DW9807AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long DW9807AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int DW9807AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
...
extern void LC898217AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
