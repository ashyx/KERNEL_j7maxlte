...
static void sensor_init(void)
{
	...
	write_cmos_sensor_8(0x303C, 0x4B);
	write_cmos_sensor_8(0x303D, 0x00);
	write_cmos_sensor_8(0x3041, 0xD7);
	write_cmos_sensor_8(0x30E0, 0x00);
	write_cmos_sensor_8(0x30E1, 0x00);
	write_cmos_sensor_8(0x30F6, 0x00);
	write_cmos_sensor_8(0x34CE, 0xFF);
	//write_cmos_sensor_8(0x3063, 0x04);
}	/*	sensor_init  */
...
static void hs_video_setting(void)
{
	...
	write_cmos_sensor_8(0x0341, 0x3A);
	write_cmos_sensor_8(0x0342, 0x05);
	write_cmos_sensor_8(0x0343, 0xB0);
	write_cmos_sensor_8(0x0344, 0x00);
	write_cmos_sensor_8(0x0345, 0x00);
	...
	write_cmos_sensor_8(0x0381, 0x01);
	write_cmos_sensor_8(0x0383, 0x07);
	write_cmos_sensor_8(0x0385, 0x01);
	write_cmos_sensor_8(0x0387, 0x07);
	write_cmos_sensor_8(0x3048, 0x23);
	write_cmos_sensor_8(0x30D5, 0x03);
	...
	write_cmos_sensor_8(0x034D, 0x88);
	write_cmos_sensor_8(0x034E, 0x01);
	write_cmos_sensor_8(0x034F, 0xE4);
	write_cmos_sensor_8(0x0305, 0x03);
	write_cmos_sensor_8(0x0307, 0x7D);
	write_cmos_sensor_8(0x3037, 0x0A);
	write_cmos_sensor_8(0x3038, 0x01);
	write_cmos_sensor_8(0x303E, 0x01);
	write_cmos_sensor_8(0x30A2, 0x0E);
	...
	write_cmos_sensor_8(0x31AA, 0x02);
	write_cmos_sensor_8(0x3301, 0x00);
	write_cmos_sensor_8(0x3318, 0x79);
	write_cmos_sensor_8(0x0202, 0x02);
	write_cmos_sensor_8(0x0203, 0x35);
