 ...
 *
 ****************************************************************************/
#ifndef _s5k2l2MIPI_SENSOR_H
#define _s5k2l2MIPI_SENSOR_H
...
/* for s5k2l2 pdaf */
extern bool s5k2l2_read_otp_pdaf_data(kal_uint16 addr, BYTE *data, kal_uint32 size, kal_uint32 sensor_id);
