...
// This flag is for EEPROM to check sensor is opened or not.
int g_is_imx258_open = 0;
...
static imgsensor_info_struct imgsensor_info = {
	...
	.pre = {
		.pclk = 508800000,	/* record different mode's pclk */
	...
	.slim_video = {		/*VT Call */
		.pclk = 436800000,	/* 158400000, */
		.linelength = 5352,
		.framelength = 2720,	/* 986,      //1236 */
		.startx = 0,
		.starty = 0,
		.grabwindow_width = 2080,	/* 1400, */
...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
	...
	{4208, 3120, 24, 0, 4160, 3120, 4160, 3120, 0000, 0000, 4160, 3120, 0, 0, 4160, 3120},	/*video */
	{4208, 3120, 8, 592, 4192, 1920, 1052, 480, 0000, 0000, 1048, 480, 0, 0, 1048, 480},	/*hight speed video */
	{4208, 3120, 24, 0, 4160, 3120, 2080, 1560, 0000, 0000, 2080, 1560, 0, 0, 2080, 1560},	/*slim video */
	/*add new mode */
	{4208, 3120, 24, 0, 4160, 3120, 4160, 3120, 0000, 0000, 4160, 3120, 0, 0, 4160, 3120},	/*custom1 */
	{4208, 3120, 24, 0, 4160, 3120, 2080, 1560, 0000, 0000, 2080, 1560, 0, 0, 2080, 1560},	/*custom2 */
};				/*custom2 */
...
static void custom1_setting(void)
{
	...
	write_cmos_sensor(0x0342, 0x14);
	write_cmos_sensor(0x0343, 0xE8);
	write_cmos_sensor(0x0340, 0x0F);/*(0x0340, 0x0C);*/
	write_cmos_sensor(0x0341, 0x50);/*(0x0341, 0x60);*/
	write_cmos_sensor(0x0344, 0x00);
	write_cmos_sensor(0x0345, 0x00);
	write_cmos_sensor(0x0346, 0x00);
	write_cmos_sensor(0x0347, 0x00);
...
static void custom2_setting(void)
{
	...
	write_cmos_sensor(0x0342, 0x14);
	write_cmos_sensor(0x0343, 0xE8);
	write_cmos_sensor(0x0340, 0x0D);/*(0x0340, 0x0A);*/
	write_cmos_sensor(0x0341, 0x38);/*(0x0341, 0xA0);*/
	write_cmos_sensor(0x0344, 0x00);
	write_cmos_sensor(0x0345, 0x00);
	write_cmos_sensor(0x0346, 0x00);
	write_cmos_sensor(0x0347, 0x00);
