...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	{ 4656, 3504,   8, 12, 4640, 3480, 4640,  3480, 0000, 0000, 4640, 3480, 0, 0, 4640, 3480},
	{ 4656, 3504,   8, 12, 4640, 3480, 4640,  3480, 0000, 0000, 4640, 3480, 0, 0, 4640, 3480}, /* capture*/
	{ 4656, 3504,   8, 12, 4640, 3480, 4640,  3480, 0000, 0000, 4640, 3480, 0, 0, 4640, 3480}, /* video */
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x30A6, 0x0000);
...
static void slim_video_setting(void)
{
	...
	write_cmos_sensor(0x0300, 0x0003);
	write_cmos_sensor(0x0306, 0x0069);
	write_cmos_sensor(0x030E, 0x003C);//0x0079
	write_cmos_sensor(0x3004, 0x0003);
	write_cmos_sensor(0x0344, 0x0008);
	write_cmos_sensor(0x0348, 0x1227);
	write_cmos_sensor(0x0346, 0x0010);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	pr_err("s5k3p8sn Sensor Control Mode [%d]\n",scenario_id);
	switch (scenario_id) {
	case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
