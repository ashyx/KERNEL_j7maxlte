...
#define PFX "IMX258_MONO_camera_sensor"
#define LOG_1 LOG_INF("IMX258_MONO,MIPI 1LANE\n")
#define LOG_2 LOG_INF("preview 1600*1200@30fps; video 1600*1200@30fps;1600*1200@30fps,600Mbps/lane\n")
/****************************   Modify end    *******************************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = IMX258_MONO_SENSOR_ID,
	...
	.normal_video = {
		...
		.grabwindow_height = 1176,
		.mipi_data_lp2hs_settle_dc = 85,/* unit , ns */
		.max_framerate = 300,/* modify */
	},
	.hs_video = {/*slow motion*/
		.pclk = 508600000,/* 518400000, */
		.linelength = 5352,
		.framelength = 792,/* 806, */
		.startx = 0,
		.starty = 0,
		.grabwindow_width = 1400,/* 1400, */
		.grabwindow_height = 752,/* 752, */
		.mipi_data_lp2hs_settle_dc = 85,/* unit , ns */
...
/*add new mode*/
	...
	.custom4 = {
		.pclk = 383400000,				/* record different mode's pclk */
		.linelength = 5352,				/* record different mode's linelength */
		.framelength = 2388,			/* record different mode's framelength */
		.startx = 0,					/* record different mode's startx of grabwindow */
		.starty = 0,					/* record different mode's starty of grabwindow */
		.grabwindow_width = 4208,		/* record different mode's width of grabwindow */
		.grabwindow_height = 2352,		/* record different mode's height of grabwindow */
		/*	 following for MIPIDataLowPwr2HighSpeedSettleDelayCount by different scenario	*/
		.mipi_data_lp2hs_settle_dc = 85,/* unit , ns */
		/*	 following for GetDefaultFramerateByScenario()	*/
		.max_framerate = 300,
...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	{ 4208, 3120, 0, 0, 4208, 3120, 2104,  1560, 0002, 0000, 2100,  1560, 0, 0, 2100, 1560},
	{ 4208, 3120, 0, 0, 4208, 3120, 4208,  3120, 0000, 0000, 4208,  3120, 0, 0, 4208, 3120}, /* capture */
	{ 4208, 3120, 0, 0, 4208, 3120, 2104,  1176, 0002, 0000, 2100,  1176, 0, 0, 2100, 1176}, /* video */
	{ 4208, 3120, 8, 0, 4192, 3120, 1400,  752,  0000, 0000, 1400,  752,  0, 0, 1400,  752},
	{ 4208, 3120, 0, 0, 4208, 3120, 2104,  1560, 0002, 0000, 2100,  1560, 0, 0, 2100, 1560},/* slim video*/
	...
	{ 4208, 3120, 0, 0, 4208, 3120, 2104,  1560, 0002, 0000, 2100,  1560, 0, 0, 2100, 1560}, /* custom3 */
	{ 4208, 3120, 0, 0, 4208, 3120, 4208,  2352, 0000, 0000, 4208,  2352, 0, 0, 4208, 2352},};
/*add end*/
...
static kal_uint16 IMX258MIPI_sensorGainMapping[IMX258MIPI_MaxGainIndex][2] = {
	{64, 0	},
	{65, 8	},
	{66, 16 },
	{67, 25 },
...
static void load_imx258_SPC_Data(void)
{
	...
	if (SPC_data_done == false) {
		if (0) {/* (!read_imx258_eeprom_SPC(0x0F73,IMX258MIPI_SPC_Data,126)) {//TODO */
...
/* unsigned long long *feature_return_para=(unsigned long long *) feature_para; */
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		/* TODO_N */
		/* read_imx258_eeprom((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)), */
