...
static void hs_video_setting_v2(void)
{
	...
	write_cmos_sensor(0x0306, 0x0078);
	write_cmos_sensor(0x030E, 0x0063);
	write_cmos_sensor(0x0344, 0x0060);
	write_cmos_sensor(0x0346, 0x01B0);
	write_cmos_sensor(0x0348, 0x101F);
	write_cmos_sensor(0x034A, 0x0A8F);
	write_cmos_sensor(0x034C, 0x03F0);
	write_cmos_sensor(0x034E, 0x0238);
	...
	write_cmos_sensor(0x0200, 0x0618);
	write_cmos_sensor(0x0202, 0x0340);
	write_cmos_sensor(0x021E, 0x0400);
	write_cmos_sensor(0x021C, 0x0000);
