...
static SET_PD_BLOCK_INFO_T imgsensor_pd_info = {
	...
	.i4SubBlkW = 16,
	.i4SubBlkH = 16,
	.i4PosL = {{92, 31}, {144, 31}, {108, 35}, {128, 35}, {96, 51}, {140, 51}, {112, 55}, {124, 55},
	{112, 63}, {124, 63}, {96, 67}, {140, 67}, {108, 83}, {128, 83}, {92, 87}, {144, 87} },
	.i4PosR = {{92, 35}, {144, 35}, {108, 39}, {128, 39}, {96, 47}, {140, 47}, {112, 51}, {124, 51},
						  ...
						  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	if (imgsensor.current_fps != imgsensor_info.cap.max_framerate)
		LOG_INF("capture: use cap30FPS's setting: %d fps!\n", imgsensor_info.cap.max_framerate/10);
...
{
	LOG_INF("streaming_enable(0= w Standby, 1= treaming): %d\n", enable);
	if (enable)
