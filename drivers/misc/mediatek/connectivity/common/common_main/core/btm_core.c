...
/*
  ...
  #define FORCE_KERNEL_PANIC              0 //0:disable 1://enable
#else
  #define FORCE_KERNEL_PANIC              1 //0:disable 1://enable
#endif
*/
#if (defined(CONFIG_WMT_FORCE_KERNEL_PANIC) && !defined(CONFIG_SAMSUNG_PRODUCT_SHIP))
#define FORCE_KERNEL_PANIC              1
#else
#define FORCE_KERNEL_PANIC              0 //0:disable 1://enable
#endif

extern OSAL_THREAD *thread_stp_btm;
INT32 gBtmDbgLevel = STP_BTM_LOG_INFO;
INT32 host_trigger_assert_flag;
#if  CFG_WMT_BUG_SWITCH
static INT32 option_trigger_ke_enable = FORCE_KERNEL_PANIC;
#else
