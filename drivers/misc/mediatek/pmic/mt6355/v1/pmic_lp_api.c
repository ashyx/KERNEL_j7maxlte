...
int pmic_ldo_vbif28_lp(BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	...
	pmic_lp_type_set(MT6355_LDO_VBIF28_OP_EN, VBIF28, SRCLKEN0, 0, 0);
	pmic_lp_type_set(MT6355_LDO_VBIF28_OP_EN, VBIF28, SRCLKEN1, 0, 0);
	pmic_lp_type_set(MT6355_LDO_VBIF28_OP_EN, VBIF28, SRCLKEN2, 0, 0);
	return 0;
}
