...
static void bootup_finish(void)
{
	...
	/* release CPU core/freq since it's boosted when PPM init for boot time optimization */
	mt_ppm_sysboost_core(BOOST_BY_BOOT_OPT, 0);
	mt_ppm_sysboost_freq(BOOST_BY_BOOT_OPT, 0);
}
