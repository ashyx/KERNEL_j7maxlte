...
#else
int NXPExtSpk_set_i2c_client(struct i2c_client *client)
{
	new_client = client;
	return 0;
}
EXPORT_SYMBOL(NXPExtSpk_set_i2c_client);

int NXPExtSpk_i2c_client_registered(void)
{
	return new_client ? 1 : 0;
}
EXPORT_SYMBOL(NXPExtSpk_i2c_client_registered);
#endif /* #ifndef CONFIG_SND_SOC_RT5509 */
#endif
