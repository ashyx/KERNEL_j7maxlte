...
// for CONFIG_MACH_MT6757
	...
	struct pinctrl *p;
	struct pinctrl_state *spi2_miso_set_cfg;
	struct pinctrl_state *spi2_miso_clr_cfg;
	struct pinctrl_state *spi2_cs_set_cfg;
	struct pinctrl_state *spi2_cs_clr_cfg;
	struct pinctrl_state *spi2_mosi_set_cfg;
	struct pinctrl_state *spi2_mosi_clr_cfg;
	struct pinctrl_state *spi2_clk_set_cfg;
	struct pinctrl_state *spi2_clk_clr_cfg;
