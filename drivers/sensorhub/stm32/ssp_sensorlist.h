...
#define SENSOR_INFO_PROXIMITY           {"proximity_sensor", true, REPORT_MODE_ON_CHANGE, 3, 1}
...
#define SENSOR_INFO_PROXIMITY_RAW       {"", true, REPORT_MODE_ON_CHANGE, 2, 0}
...
#define SENSOR_INFO_PROXIMITY_1BYTE     {"proximity_sensor", true, REPORT_MODE_ON_CHANGE, 2, 1}
#define SENSOR_INFO_PROXIMITY_RAW_1BYTE {"", true, REPORT_MODE_ON_CHANGE, 1, 0}
