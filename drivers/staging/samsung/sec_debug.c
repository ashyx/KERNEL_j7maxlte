...
#define SEC_EXTRA_INFO_BASE	0x43200000
static u32 __initdata sec_extra_info_base = SEC_EXTRA_INFO_BASE;
static u32 __initdata sec_extra_info_size = SZ_1M;
...
{
	sec_debug_info = (struct sec_debug_shared_info *)persistent_ram_vmap(
			(phys_addr_t)sec_extra_info_base, (phys_addr_t)sec_extra_info_size, 0);
