...
static void *ion_page_pool_alloc_pages(struct ion_page_pool *pool)
{
	...
	unsigned long long last_timeout_time = 0;
	struct page *page;
	...
	/* unit is ns, alloc timeout is 10ms */
	if ((end - start > 10000000ULL) && (end - last_timeout_time > 1000000000ULL)) {
