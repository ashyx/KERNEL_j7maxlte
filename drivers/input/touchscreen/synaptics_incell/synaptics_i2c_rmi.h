...
#define DEBUG_STR_LEN	(SEC_CMD_STR_LEN * 2)
...
enum f54_report_types {
	...
	/* hic f54 test reporting + */
	F54_HIC_RX_SHORT = 125,
	F54_HIC_TX_SHORT = 126,
	/* hic f54 test reporting - */
...
struct synaptics_rmi4_data {
	...
	struct timeval time_pressed[MAX_NUMBER_OF_FINGERS];
	struct timeval time_released[MAX_NUMBER_OF_FINGERS];
	long time_longest;
